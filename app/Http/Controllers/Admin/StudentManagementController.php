...
class StudentManagementController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Apply sorting based on program, year, and section
        $students = $query
            ->orderByRaw('FIELD(program, "BSIT", "BLIS", "BSCS", "BSIS")') // Order by program
            ->orderBy('year', 'asc') // Order by year (numeric order)
            ->orderBy('section', 'asc') // Order by section (alphabetical order)
            ->paginate(10);
